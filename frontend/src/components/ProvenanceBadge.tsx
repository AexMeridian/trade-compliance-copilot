...
export function ProvenanceBadge({ source }: { source: Provenance }) {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="inline-flex items-center gap-1.5 rounded-sm border border-hairline bg-paper-raised px-2 py-0.5 text-xs text-ink-muted no-underline hover:border-accent hover:text-accent"
