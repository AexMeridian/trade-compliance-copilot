...
export const AGENCY_HINTS: Record<string, string> = {
  ...
  'International Trade Administration':
    'Part of the Commerce Department: decides antidumping and countervailing-duty cases (penalties on unfairly priced imports).',
...
export const NEWS_CATEGORY_HINTS: Record<string, string> = {
  ...
  'Elections & Politics':
    "Headlines about elections in countries we can identify. Pulled from news headlines, not an election calendar, so upcoming elections won't appear until they're reported.",
